...
var calls = exports.requests = {
    ...
    GetMyFeesEstimate: function() {
        return new ProductsRequest('GetMyFeesEstimate', {
            ...
            ListingPriceAmount: { name: 'FeesEstimateRequestList.FeesEstimateRequest.1.PriceToEstimateFees.ListingPrice.Amount', required: true},
            ListingPriceCurrencyCode: { name: 'FeesEstimateRequestList.FeesEstimateRequest.1.PriceToEstimateFees.ListingPrice.CurrencyCode', required: true},
            ShippingAmount: { name: 'FeesEstimateRequestList.FeesEstimateRequest.1.PriceToEstimateFees.Shipping.Amount', required: true},
            ShippingCurrencyCode: { name: 'FeesEstimateRequestList.FeesEstimateRequest.1.PriceToEstimateFees.Shipping.CurrencyCode', required: true},
            PointsNumber: { name: 'FeesEstimateRequestList.FeesEstimateRequest.1.PriceToEstimateFees.Points.PointsNumber', required: true},
            PointsMonetaryValueAmount: { name: 'FeesEstimateRequestList.FeesEstimateRequest.1.PriceToEstimateFees.Points.PointsMonetaryValue.Amount', required: true},
            PointsMonetaryValueCurrencyCode: { name: 'FeesEstimateRequestList.FeesEstimateRequest.1.PriceToEstimateFees.Points.PointsMonetaryValue.CurrencyCode', required: true},
        });
    },
